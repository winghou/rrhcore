...
(function ($) {
    ...
    $.mobiscroll.themes.jqm = {
        ...
        onMarkupInserted: function (elm, inst) {
            ...
            $('.', elm).addClass('ui-body-' + s.jqmLine);
        ...
        function scrollToPos(time, index, manual, dir, active) {
            ...
            setTimeout(function(){
                $("#demo-inline").next().find('div.dw-li').each(function(){
             	   if($(this).attr("aria-selected")=="true"){
             		   data1Val=$(this).attr("data-val");
                 		 $(".loanMoney").text(($(this).find('div.dw-i').text())*(1-cutRate)+"元");
                 		 $(".moneyOfInsurance").text(($(this).find('div.dw-i').text())*cutRate+"元");
                ...
                $.each(wg, function (j, w) { // Wheels
                    ...
                    html += '<' + (hasFlex ? 'div' : 'td') + ' class="dwfl"' + ' style="' +
                                ...
                                '<div tabindex="0" aria-live="off" aria-label="' + lbl + '" role="listbox" class="dwww">' +
                                    '<div class="dww" style="height:' + 120 + 'px;">' +
                                        '<div class="dw-ul" style="margin-top:' + 40 + 'px;">';
