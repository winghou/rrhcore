var isiPhoneX;
$(function(){
	isiPhoneX = ns.getRequestParam().isiPhoneX;
	if(isiPhoneX == 1){
		$(".header").css("padding","44px 0 9px 0");
		$(".header span").css("top","44px");
	}
})
/*
CryptoJS v3.1.2
...
var key = CryptoJS.enc.Utf8.parse("mochouhuaNumber1");
var iv = CryptoJS.enc.Utf8.parse('number1Mochouhua');
...
var commonUrl="http://api.mochoupay.com/";
//var commonUrl="http://122.112.213.19:8099/rrhcore/";
//var commonUrl="http://192.168.1.195:8080/rrhcore";
$(function() {
...
function showPanel(content){
	$(".tipsPanel").removeClass("hide");
	$(".contentword").text(content);
}
function hidePanel(){
	$(".tipsPanel").addClass("hide");
	$(".contentword").text("");	
}