 ...
 */
 ...
 function EmailAutoComplete(options) {
	...
	this.config = {
		...
		mailArr        : ["@qq.com","@126.com","@163.com","@sina.com"], //邮箱数组
	...
	_renderHTML: function(cfg) {
		...
		if(curIndex > -1){
			...
			if(_cache.onlyFlag) {
				...
				$('.auto-tip',cfg.parentNode).css({'position':'absolute','top':cfg.height+5,'width':cfg.width - 2 + 'px','left':0,
					'border':'none','z-index':10000,'background-color':"#fff"});
			}
