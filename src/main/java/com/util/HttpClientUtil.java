...
public class HttpClientUtil {
	...
	public static String doPostJson(String url, String json, String auth) {
		...
		try {
			// 创建Http Post请求
			HttpPost httpPost = new HttpPost(url);
			httpPost.setHeader("Authorization", "Basic " + (new sun.misc.BASE64Encoder()).encode(auth.getBytes()));
	...
	public static String doPostStr(String url,String value) {
		// 创建Httpclient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
		String resultString = "";
		try {
			...
			// 模拟表单
			StringEntity reqEntity = new StringEntity(value);
	...
	public static String doPost2(String url,JSONObject json,String charset,int time){  
