...
public class ValidateUtil
{
     ...
     * 
     * @param phoneNo
     *            需要校验固定电话号码(区号+座机号码+分机号码):“0”+2位或3位数字+“-” 1位数字+6或7位数字
     *            “-”+1到4位分机号
    ...
    public static boolean isMobileNo(String mobileNo)
    {
        ...
        Pattern p = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(18[012356789])|170|177)\\d{8}$");
     ...
     * @return
     */
    public static boolean isLpno(String lpno)
    {
        if (null == lpno)
        {
            return false;
        }
        Pattern pattern = Pattern.compile("^[\u4e00-\u9fa5|WJ|wj]{1}[A-Za-z0-9]{6}$");
        return pattern.matcher(lpno).matches();
    }
    
    public static void main(String[] args)
    {
        System.out.println(isLpno("苏e2y030"));
    }
